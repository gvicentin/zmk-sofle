...
The Sofle V2 is 6×4+5 keys column-staggered split keyboard, using Cherry switches.

The Sofle V2 Wireless uses a Nice!Nano microcontroller and runs the ZMK firmware. Follow the guide bellow on how to flash the ZMK firmware to the Nice!Nano microcontroller.
